...
var germanMessages = map[string]string{
	...
	"places.stock_warning":    "Dieser Ort enthält aktuellen Bestand. Verteile Produkte zuerst auf andere Orte, oder archiviere trotzdem.",
...
var englishMessages = map[string]string{
	...
	"places.stock_warning":    "This place contains current stock. Distribute products to other places first, or archive anyway.",
