...
var germanMessages = map[string]string{
	...
	"scan.unsupported":        "Automatisches Scannen wird von diesem Browser nicht unterstützt. Nutze die Systemkamera oder füge einen Scan-Link ein.",
	"scan.camera_error":       "Kamera konnte nicht gestartet werden. Prüfe Browserberechtigungen oder nutze den manuellen Link.",
	"scan.manual_label":       "Scan-Link manuell einfügen",
	"scan.manual_placeholder": "https://example.com/scan/...",
	"scan.open":               "Scan öffnen",
	"scan.dev_fallback":       "Dev-QRs anzeigen",
...
var englishMessages = map[string]string{
	...
	"scan.unsupported":        "Automatic scanning is not supported by this browser. Use your system camera or paste a scan link below.",
	"scan.camera_error":       "Could not start the camera. Check browser permissions or use the manual link.",
	"scan.manual_label":       "Paste scan link manually",
	"scan.manual_placeholder": "https://example.com/scan/...",
	"scan.open":               "Open scan",
	"scan.dev_fallback":       "Show dev QRs",
