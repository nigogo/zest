...
func (a *App) templates() {
	a.tmpl = template.Must(template.New("base").Funcs(template.FuncMap{"productClass": productClass, "productStyle": productStyle, "eventSign": eventSign, "eventText": eventText, "unit": unitLabel, "t": tr, "abs": func(n int) int {
		if n < 0 {
			return -n
		}
		return n
