...
func (a *App) templates() {
	a.tmpl = template.Must(template.New("base").Funcs(template.FuncMap{"productClass": productClass, "eventSign": eventSign, "t": tr, "abs": func(n int) int {
		if n < 0 {
			return -n
		}
		return n
...
var messages = map[string]map[string]string{
	"de": {
		"nav.places": "Orte", "nav.events": "Ereignisse", "nav.admin": "Admin", "nav.settings": "Einstellungen", "nav.logout": "Abmelden",
		"login.tag": "Scannen. Buchen. Fertig.", "login.title": "Anmelden", "login.copy": "Schnelle Bestandsführung für die Praxis.", "login.email": "E-Mail", "login.password": "Passwort", "login.submit": "Anmelden", "login.register": "Konto erstellen",
		"register.tag": "Team beitreten", "register.title": "Konto erstellen", "register.name": "Name", "register.submit": "Konto erstellen",
		"settings.title": "Einstellungen", "settings.language": "Sprache", "settings.device": "Gerätesprache", "settings.english": "Englisch", "settings.german": "Deutsch", "settings.save": "Einstellungen speichern", "settings.saved": "Einstellungen gespeichert.", "settings.copy": "Wähle eine Sprache oder verwende die Standardsprache deines Geräts.",
		"places.eyebrow": "Operator-Orte", "places.title": "Orte", "places.copy": "Öffne einen Ort, scanne einen Befehls-QR-Code und arbeite weiter.", "places.devqr": "Dev-QRs", "places.active": "Aktiv", "places.cardcopy": "Aktuellen Bestand und letzte Bewegungen ansehen.", "places.empty": "Noch keine aktiven Orte.",
		"place.eyebrow": "Aktiver Ort", "place.stock": "Aktueller Bestand je Produkt.", "place.approved": "Freigegeben", "place.here": "hier", "place.zero": "Nullbestand.", "place.negative": "Negativer Bestand. Prüfe die letzte Bewegung.", "place.recent": "Letzte Aktivität", "place.viewall": "Alle anzeigen", "place.recentempty": "Letzte Bewegungen erscheinen nach Scans.", "place.scannext": "Weiter scannen",
		"events.eyebrow": "Audit-Zeitleiste", "events.title": "Letzte Ereignisse", "events.empty": "Noch keine Ereignisse.", "events.added": "Hinzugefügt", "events.subtracted": "Entnommen", "events.reversal": "Storno von",
		"admin.backoffice": "Backoffice", "admin.title": "Admin-Dashboard", "admin.approvals": "Ausstehende Freigaben", "admin.products": "Produkte", "admin.reports": "Berichte", "admin.settings": "Einstellungen", "admin.total": "Gesamtbestand", "admin.today": "Ereignisse heute", "admin.negative": "Negativer Bestand", "admin.activeplaces": "Aktive Orte", "admin.activeproducts": "Aktive Produkte",
		"reports.title": "Bewegungsberichte", "reports.export": "CSV exportieren", "result.current": "Aktueller Bestand hier", "result.undoq": "Diesen Scan korrigieren?", "result.undocopy": "Rückgängig erstellt ein Stornoereignis. Der Audit-Trail bleibt erhalten.", "result.viewplaces": "Orte anzeigen",
	},
}

var englishMessages = map[string]string{
	"nav.places": "Places", "nav.events": "Events", "nav.admin": "Admin", "nav.settings": "Settings", "nav.logout": "Logout",
	"login.tag": "Scan. Move. Done.", "login.title": "Log in", "login.copy": "Fast inventory for real-world work.", "login.email": "Email", "login.password": "Password", "login.submit": "Log in", "login.register": "Create an account",
	"register.tag": "Join your team", "register.title": "Create account", "register.name": "Name", "register.submit": "Create account",
	"settings.title": "Settings", "settings.language": "Language", "settings.device": "Device default", "settings.english": "English", "settings.german": "German", "settings.save": "Save settings", "settings.saved": "Settings saved.", "settings.copy": "Choose a language or use your device default.",
	"places.eyebrow": "Operator places", "places.title": "Places", "places.copy": "Open a place, scan a command QR, and keep moving.", "places.devqr": "Dev QRs", "places.active": "Active", "places.cardcopy": "View current stock and recent movement.", "places.empty": "No active places yet.",
	"place.eyebrow": "Active place", "place.stock": "Current stock by product.", "place.approved": "Approved", "place.here": "here", "place.zero": "Zero stock.", "place.negative": "Negative stock. Check the last movement.", "place.recent": "Recent activity", "place.viewall": "View all", "place.recentempty": "Recent movement appears after scans.", "place.scannext": "Scan next",
	"events.eyebrow": "Audit timeline", "events.title": "Recent events", "events.empty": "No events yet.", "events.added": "Added", "events.subtracted": "Subtracted", "events.reversal": "Reversal of",
	"admin.backoffice": "Backoffice", "admin.title": "Admin dashboard", "admin.approvals": "Pending approvals", "admin.products": "Products", "admin.reports": "Reports", "admin.settings": "Settings", "admin.total": "Total stock", "admin.today": "Events today", "admin.negative": "Negative stock", "admin.activeplaces": "Active places", "admin.activeproducts": "Active products",
	"reports.title": "Movement reports", "reports.export": "Export CSV", "result.current": "Current stock here", "result.undoq": "Need to correct this scan?", "result.undocopy": "Undo creates a reversal event. The audit trail stays intact.", "result.viewplaces": "View places",
}
