...
var germanMessages = map[string]string{
	...
	"scan.unsupported":        "Automatisches Scannen wird von diesem Browser nicht unterstützt. Nutze die Systemkamera deines Geräts.",
...
var englishMessages = map[string]string{
	...
	"scan.unsupported":        "Automatic scanning is not supported by this browser. Use your device camera instead.",
