...
func (a *App) routes(m *http.ServeMux) {
	...
	m.HandleFunc("/dev/qr-codes", func(w http.ResponseWriter, r *http.Request) { http.Redirect(w, r, "/admin/qr-codes", 301) })
